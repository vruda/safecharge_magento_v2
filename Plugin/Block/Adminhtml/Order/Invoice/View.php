    ...
    public function beforeSetLayout(\Magento\Sales\Block\Adminhtml\Order\Invoice\View $view)
    {
        try {
            ...
            if ($orderPayment->getMethod() === Payment::METHOD_CODE) {
				...
				// hide the button all the time, looks like we have order with multi partial settled items, the Void logic is different than the logic of the Void button in Information tab
